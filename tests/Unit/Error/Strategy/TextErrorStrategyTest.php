...
/**
 * Unit test for {@see Zenigata\Http\Error\Strategy\TextErrorStrategy}.
 *
 * Covered cases:
 *
 ...
 */
#[CoversClass(TextErrorStrategy::class)]
final class TextErrorStrategyTest extends TestCase
{
    private Exception $error;
    
    private TextErrorStrategy $strategy;
    ...
    protected function setUp(): void
    {
        ...
        $this->strategy = new TextErrorStrategy();
